...
This project is focused on using the _pandas_ library.

The starter code for this project was given [here](https://freecodecam-boilerplate-9ycrvwxrzn4.ws-eu116.gitpod.io/).

#### Here is the official description from the FreeCodeCamp website:
